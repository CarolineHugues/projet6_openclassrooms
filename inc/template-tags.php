...
/* ------------------------------------------------------------------------
				Events - functions for the plugin Event organiser
---------------------------------------------------------------------------*/
...
function get_similar_partners($categories){
	return $similarpartners = array(
		'posts_per_page' => 3,
		'post_type' =>  'post',
		'tag' => 'partenariat',
...
/* ------------------------------------------------------------------------
				All partners or sorting by category
---------------------------------------------------------------------------*/
...
function get_args_partners_sorting_categories(){
	return $cat_args = array(
		'show_option_none' => __( 'Toutes catégories' ),
		'option_none_value'  => 'tous',
		'orderby'      => 'name',
...
function get_similar_articles($categories){
	return $similararticles = array(
		'posts_per_page' => 3,
		'post_type' =>  'post',
		'tag__not_in' => 17,
		'category_name' => $categories[0]->name,
